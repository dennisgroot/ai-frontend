...
const globalSiteData = {
    title: "Raadhuis boilerplate",
    description: "Raadhuis boilerplate op basis van 11ty (eleventy), Tailwind CSS en Alpine JS",
    baseUrl: baseUrl,
    locale: 'nl',
}
...
module.exports = function (eleventyConfig) {
    ...
    eleventyConfig.addShortcode("image", async function (src, alt, sizes = defaultSizesConfig) {
        ...
        let metadata = await Image(src, {
            ...
            formats: ["webp", "jpeg"],
            urlPath: "/assets/img/",
            outputDir: "./webroot/wp-content/themes/raadhuis/dist/assets/img/",
    ...
    /* --- WATCH TARGETS --- */
    eleventyConfig.addWatchTarget("./webroot/wp-content/themes/raadhuis/**/*.php");
    eleventyConfig.addWatchTarget("./webroot/wp-content/plugins/raadhuis-*/**/*.php");

    /* --- BASE CONFIG --- */
    return {
        dir: {
            input: "src",
            output: "./webroot/wp-content/themes/raadhuis/dist",
            includes: "partials", // this path is releative to input-path (src/)
